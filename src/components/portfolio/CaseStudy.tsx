...
const labels = {
  en: {
    ...
    contactBody: "I can go deeper on the trade-offs, implementation boundaries, operational decisions, and engineering judgement behind this work.",
    email: "Email Jerome",
  ...
  zh: {
    ...
    results: "交付结果",
    contact: "深入讨论这个项目",
    contactBody: "可以继续讨论这个项目的技术取舍、实现边界、运行决策与工程判断。",
    email: "邮件联系",
    professional: "职业项目",
    independent: "独立产品",
    evidenceLabel: "证据",
