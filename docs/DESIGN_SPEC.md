...
- 超大标题：首屏 H1 使用 64-104px 范围，移动端降到 44-56px。
...
- 细微纹理：1px grid、noise、hairline border，不用大面积装饰图案。
...
2. Filter bar：All、Full-stack、Frontend structure、Mobile、Realtime、AI、Enterprise。
3. Project grid：重点项目跨 2 列，普通项目单列。
4. Evidence badges：Live、Code、Case Study、Architecture、Testing。
5. Empty state：没有筛选结果时提供 reset。
